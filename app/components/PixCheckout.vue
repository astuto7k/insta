...
<template>
  <div class="w-full flex flex-col items-center gap-6">
    ...
    <div
      v-else-if="erro"
      class="flex flex-col items-center gap-4 bg-red-500/10 border border-red-500/30 p-6 rounded-2xl w-full max-w-md"
    >
      ...
      <div class="text-center space-y-2 w-full">
        <p class="text-red-400 font-bold block">
          Falha na PayEvo
        </p>
        ...
        <p class="text-gray-500 text-xs mt-2">
          Envie este erro para o suporte da PayEvo.
        </p>
      </div>
      <button
    ...
    <template v-else-if="pixData">
      ...
      >
        ...
        <h3 class="text-green-400 font-bold text-xl">
          Pagamento Aprovado!
        </h3>
      ...
      >
        ...
        <div class="bg-white p-4 rounded-2xl shadow-lg">
          ...
          <div
            v-else
            class="w-[200px] h-[200px] bg-gray-100 flex items-center justify-center text-gray-400 text-xs text-center p-4"
          >
